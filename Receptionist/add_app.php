      ...
      <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-10">
          ...
          if(isset($_POST['sub'])){
            ...
            $at=$_POST['atime'];
            $name=$_POST['id'];
            $sql="INSERT INTO appointments(date,time,c_id,service) values('$ad','$at','$name','$ser')";
          ...
          <form method="POST" action="<?php $_SERVER['PHP_SELF']?>" class="form" style="margin-top:30px">
            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                <label for="Names" class="label-control" id="headerb" >Clients Id</label>
                <input type="text" name="id" class="input-md form-control" placeholder="Id Number" required/>
              </div>
            </div><br/>
            <button class="btn btn-block btn-primary"type="submit" name="sub" id="headerb">Add Appointment</button>
            <input type="hidden"/>
          </br>
          </fieldset>
          </form>
